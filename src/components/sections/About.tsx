      ...
      <div className="mt-16 grid grid-cols-1 gap-12 lg:grid-cols-12 lg:gap-16">
        ...
        <div className="flex flex-col gap-10 lg:col-span-8">
          <Reveal as="p" className="max-w-2xl text-2xl leading-snug text-fg text-balance md:text-3xl">
            I&apos;m {site.firstName}, a full-stack engineer who thinks in TypeScript systems.
            Over{" "}
            ...
            <span className="text-accent">fintech apps</span> — owning React frontends,
            Node.js services, testing, CI/CD, and observability through production.
          </Reveal>
